...
class KatapultNoDeployerErrorMenu(BaseMenu):
    def __init__(self, previous_menu: Type[BaseMenu] | None = None):
        super().__init__()
        self.title = "!!! NO DEPLOYER FILE FOUND !!!"
    ...
    def print_menu(self) -> None:
        line1 = "Unable to find a compiled deployer file!"
        menu = textwrap.dedent(
            ...
            ║                                                       ║
            ║ Make sure, that:                                      ║
            ║ ● the folder '~/katapult/out' and its content exist   ║
...
# noinspection PyUnusedLocal
# noinspection PyMethodMayBeStatic
class KatapultNoBoardTypesErrorMenu(BaseMenu):
    def __init__(self, previous_menu: Type[BaseMenu] | None = None):
        super().__init__()
